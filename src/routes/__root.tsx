    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Sepertinya kamu tersesat di gang yang salah. Yuk balik ke beranda.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ada sedikit gangguan. Coba muat ulang atau kembali ke beranda.
        </p>
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-full border border-input bg-background px-4 py-2 text-sm font-medium text-foreground hover:bg-secondary"
          >
            Beranda
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bergandeng Tengen · Kalurahan Sosromenduran" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Bergandeng Tengen · Kalurahan Sosromenduran" },
      {
        ...
        content:
          "Kenali 7 kampung, UMKM, kuliner, dan budaya Kalurahan Sosromenduran Yogyakarta.",
      },
